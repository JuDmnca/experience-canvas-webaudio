...
## l'expérience
L'expérience se déroule en plusieurs étapes : rentrer son prénom, s'enregistrer en chantant/parlant puis créer son tableau avec sa souris selon les données précedemment rentrées.

## le but
Le but est de créer une oeuvre à partir de soi-même à l'aide de son prénom et d'un enregistrement vocal. 

## restitution
À la fin de l'expérience, on peut accéder à son oeuvre ainsi que celles des autres utilisateurs dans une galerie.
